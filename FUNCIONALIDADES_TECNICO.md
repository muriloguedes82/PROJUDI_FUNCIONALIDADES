...
|---|---|---|
| 13 | Download resiliente a CORS via service worker | `background.js` |
| 14 | Autenticação Microsoft Graph (OAuth via `chrome.identity`) | `background.js`, `options.html`, `options.js` |
| 15 | Modo alternativo de e-mail sem Azure AD (fallback semiautomático) | `email.js`, `owa-attach.js` |
| 16 | Página de opções da extensão | `options.html`, `options.js` |
| 17 | Fechamento robusto de popups nativos do Projudi (`flagClosePopup`) | `closeShim.js`, `quickActions.js` |
| 18 | Cópia de arquivos para a área de transferência (offscreen) | `clipboardProcess.js`, `clipboardOffscreen.js`, `clipboardOffscreen.html` |
| 19 | Resiliência a troca de abas / recriação de containers do DOM | `content.js`, `email.js`, `quickActions.js` |
| 20 | Fila de ordenações + reenvio em segundo plano ("Nova Ordenação") | `ordenarCumprimentos.js`, `ordenarCumprimentos.css` |

### 13. Download resiliente a CORS
...
### 14. Autenticação Microsoft Graph
...
### 15. Modo alternativo sem Azure AD
...
### 17. Fechamento robusto de popups nativos
...
### 18. Cópia para área de transferência (offscreen)
...
### 19. Resiliência a troca de abas
...
### 20. Fila de ordenações + reenvio em segundo plano
