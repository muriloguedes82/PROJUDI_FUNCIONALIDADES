...
O botão **⚖️ (Des)Habilitar Advogado** abre a tela nativa de advogados do
processo em uma janela sobreposta, sem exigir que o usuário navegue antes
até a aba **Partes e Outros**. Nessa janela continuam disponíveis as ações
nativas de adicionar, habilitar, desabilitar e remover advogado.

## Retorno de mandados

Nas pendências de **Cumprimentos Aguardando Análise de Retorno**, o botão
**Analisar Retorno** abre diretamente a etapa nativa de análise dentro de
uma janela sobreposta, mantendo a página atual. O mesmo atalho aparece nas
linhas com status **Aguardando Análise de Retorno (Mandado Retornado)**.
Ao passar o mouse sobre a pendência, o Preview considera apenas os
documentos retornados pelo oficial de justiça e também oferece o acesso à
análise correspondente.

## Indicador de suspensão ativa

A extensão consulta a aba **Informações Adicionais** e mostra, ao lado do
número do processo, um aviso para cada suspensão ativa reconhecida. O
aviso informa a parte, o motivo e, quando disponível, a data de início.
São reconhecidas suspensões relacionadas ao art. 366 do CPP, art. 89 da
Lei 9.099/95, insanidade mental, ANPP e transação penal.

## Indicador de monitoração ativa

Quando o processo possui **monitoração eletrônica ativa**, a extensão
mostra um aviso no cabeçalho com o nome da parte monitorada e, quando
disponível, a data de início. A consulta é feita em segundo plano a partir
das medidas cautelares registradas nas Informações Adicionais, sem exigir
que o usuário abra essa aba manualmente.
...
insere uma checkbox. O botão flutuante **"✉️ Enviar por e-mail"** funciona
com ou sem nenhum arquivo marcado, para
...
**"✉️ Enviar por e-mail"** abre um menu. A opção **"Alterar Remetente"** abre uma
tela para cadastrar até **20** contas remetentes (Nome + E-mail),
