...
//    documentos selecionados para a pasta Downloads do usuário. O content
//    script src/owa-attach.js, injetado na própria página do Outlook Web,
//    mostra um aviso com os nomes dos arquivos baixados e instrui o
//    usuário a anexá-los via "Anexar arquivo" → "Navegar neste
//    computador".
//
//    Este modo já tentou anexar os arquivos automaticamente de três
//    formas diferentes (preenchendo o <input type="file"> via script,
//    simulando o "drop" inteiro via dispatchEvent, e um elemento
//    arrastável real para que o "dragstart" fosse disparado por um gesto
//    genuíno do usuário) e nenhuma funcionou: o Outlook Web trata esses
//    casos de forma diferente de um anexo manual real, ora forçando um
//    upload para o OneDrive que falha para um arquivo montado em memória,
//    ora nem chegando a reconhecer o arraste como um arquivo válido.
//    Testado e confirmado: o mesmo arquivo anexado manualmente pelo botão
//    "Anexar arquivo" funciona sem problemas. Por isso este modo ficou
//    semiautomático (baixa os arquivos e orienta o caminho manual
//    comprovado), em vez de insistir em mais automação de DOM.
